...
class Assets(BaseResource):
    ...
    @classmethod
    def create(cls, token, site_id, asset, parameters={}):
    ...
    @classmethod
    def retrieve_one(cls, token, site_id, asset_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
    ...
    @classmethod
    def retrieve_all(cls, token, site_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        return cls._retreive_all(token, parameters=parameters, ids={'site_id': site_id})

    @classmethod
    def update(cls, token, site_id, asset, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        cls.validate_is_entity(asset, Asset)
        return cls._update(token, asset, parameters=parameters, ids={'site_id': site_id})

    @classmethod
    def delete(cls, token, site_id, asset_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
