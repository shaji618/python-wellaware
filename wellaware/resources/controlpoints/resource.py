...
class ControlPoints(BaseResource):
    ...
    @classmethod
    def create(cls, token, site_id, asset_id, point_id, control_point, parameters={}):
    ...
    @classmethod
    def retrieve_one(cls, token, site_id, asset_id, point_id, control_point_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
    ...
    @classmethod
    def retrieve_all(cls, token, site_id, asset_id, point_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
    ...
    @classmethod
    def update(cls, token, site_id, asset_id, point_id, control_point, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
        cls.validate_is_entity(control_point, ControlPoint)
    ...
    @classmethod
    def delete(cls, token, site_id, asset_id, point_id, control_point_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
        control_point_id = cls.get_entity_id(control_point_id, ControlPoint)
    ...
    @classmethod
    def on_demand_read_options(cls, token, site_id, asset_id, point_id, control_point_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
        control_point_id = cls.get_entity_id(control_point_id, ControlPoint)
    ...
    @classmethod
    def on_demand_set_options(cls, token, site_id, asset_id, point_id, control_point_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
        control_point_id = cls.get_entity_id(control_point_id, ControlPoint)
    ...
    @classmethod
    def on_demand_read(cls, token, site_id, asset_id, point_id, control_point_id, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
        control_point_id = cls.get_entity_id(control_point_id, ControlPoint)
    ...
    @classmethod
    def on_demand_set(cls, token, site_id, asset_id, point_id, control_point_id, set_point_request, parameters={}):
        site_id = cls.get_entity_id(site_id, Site)
        asset_id = cls.get_entity_id(asset_id, Asset)
        point_id = cls.get_entity_id(point_id, Point)
        control_point_id = cls.get_entity_id(control_point_id, ControlPoint)
